...
const STAGES = [
  ...
  },
  {
    ...
    ai:  { img: imgAiAGI,           imgAlt: "Advanced AGI humanoid robot",        era: "Near Future",             name: "Advanced AGI",        subtitle: "The Convergence Point",       body: "A system with cognitive breadth across every domain — not narrow expertise, but true generality. It plans, creates, reasons, and improves itself. What biology built over 4.5 billion years, silicon compresses into decades. The next stage is being written.",                                                                              stat: "∞",       statLabel: "Potential, unbounded",          tag: "Artificial", isAGI: true },
      ...
      <section className={`aev-hero ${heroReady ? "aev-hero--ready" : ""}`}>
        ...
        <div className="aev-hero-inner">
          ...
          <div className="aev-hero-stats">
            ...
            <div className="aev-hstat-div" />
            <div className="aev-hstat">
              <span className="aev-hstat-num">7</span>
              <span className="aev-hstat-label">Parallel stages</span>
            </div>
          </div>
        </div>
                ...
                <div className="aev-body">
                  ...
                  {stage.ai.isAGI && (
                    <div className="aev-agi-badge">
                      ...
                      Advanced General Intelligence · The Next Threshold
                    </div>
                  )}
                </div>
              </div>
