...
import flyingBot from "../../assets/images/flyingbot.png"; // ← add your robot image here
    ...
    <>
      <section className="hero" style={{ backgroundImage: `url(${heroBg})` }}>
        ...
        <div className="hero-container">
          ...
          {/* RIGHT — Globe + flying robot */}
          <div className="hero-right">
            <Globe />

            {/*
              Robot orbits the globe:
              • Flies right-to-left, arcing above centre
              • At the halfway point scaleX flips to -1 so the face
                always points in the direction of travel
              • Adjust the translate() values in Hero.css (@keyframes robotFly)
                to widen / raise the orbit path
            */}
            <div className="flying-robot" aria-hidden="true">
              <img src={flyingBot} alt="" />
            </div>
          </div>
